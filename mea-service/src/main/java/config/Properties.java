...
public interface Properties {
	...
	Path DEFUALT_PRIMITIVE_DATA_PATH = Paths.get("src/resource/primitiveData.xml");
	Path DEFUALT_PRIMITIVE_DATA_PATH_120 = Paths.get("src/resource/SMSData120.xml");
	Path DEFUALT_PARTICIPLE_RESULT_PATH = Paths.get("src/resource/participleResult.txt");
	...
	interface ApiParam{
		String LTP_URL ="http://api.ltp-cloud.com/analysis/?";
	...
	interface TestPath {
			...
			Path TEST_DATA_PATH = Paths.get("src/resource/ToTestSMSData.xml");
